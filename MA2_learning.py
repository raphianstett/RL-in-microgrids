    ...
    def iterate(data, n_episodes, mdp_A, mdp_B, lr, gamma):
        ...
        for e in range(n_episodes):
            ...
            for i in range(1,l): 
                ...
                next_state_A = State.get_next_state(state_A, action_A, data[i,0], data[i,2], data[(i+1)%l,2] ,data[i,4], mdp_A)
                next_state_B = State.get_next_state(state_B, action_B, data[i,1], data[i,3], data[(i+1)%l,3] ,data[i,4], mdp_B)
