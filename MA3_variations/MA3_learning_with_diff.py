...
from MA3_variations.MA3_environment_with_diff import State
    ...
    def iterate(data, n_episodes, mdp):
        ...
        for e in range(n_episodes):
            ...
            for i in range(0, l): 
                ...
                next_state_A = State.get_next_state(state_A,data[i,0], data[i,3] ,data[i,7], mdp, action_A, action_B, action_C)
                next_state_B = State.get_next_state(state_B,data[i,1], data[i,4] ,data[i,7], mdp, action_A, action_B, action_C)
                next_state_C = State.get_next_state(state_C,data[i,2], data[i,5] ,data[i,7], mdp, action_A, action_B, action_C)
        ...
        return Q_A, Q_B,Q_C, rewards_per_episode #, all_rewards, chosen_actions, states_id, states, battery
