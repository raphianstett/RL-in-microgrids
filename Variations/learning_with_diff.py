...
from Variations.environment_with_diff import Reward


# implementation of q-learning algorithm on MDP with difference
class QLearning:
# define parameters for q-learning
    def iterate(data, n_episodes, lr, gamma, mdp):
        ...
        for e in range(n_episodes):
            ...
            # to sum the rewards that the agent gets from the environment
